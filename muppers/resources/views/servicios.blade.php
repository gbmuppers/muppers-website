...
<head>
    ...
    <title>Servicios | Muppers.com</title>
    <meta property="og:title" content="Muppers">
    <meta property="og:type" content="website">
    <meta name="description" content="Muppers. Software Development Company. Empresa de Desarrollo de Software. Nuestros Servicios.">
    ...
    <section id="services" class="services">
        <div class="container-md section-title">
            <div class="text-center">
                <h2 style="color: #cdd1d3;">Nuestros&nbsp;<span style="color: #cdd1d3;"><strong>servicios</strong></span>&nbsp;</h2>
                <p class="d-inline-block" style="width: 80%;color: #cdd1d3;text-align: center;"><strong>Para Muppers es importante ofrecerte un servicio de calidad y que se ajuste a lo que tienes planeado. Te dejamos algunos servicios predeterminados para que puedas verlos. Si no son lo que estás buscando no dudes en contactarnos, estaremos felices de hacerte una cotización.&nbsp;</strong></p>
            </div>
            <div class="row">
