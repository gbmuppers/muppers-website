...
</nav><div data-ride="carousel" class="carousel slide" id="carousel-1">
    ...
    <div class="container" style="margin-top: 0;">
        <div class="row" style="margin-top: 2.5em;">
            <div class="col-md-6" style="border: 0 none #cdd1d3 ;">
                ...
                <p style="text-align: center;font-size: 1.02rem;color: rgb(255,255,255);">&nbsp;Ser la empresa líder en el estado de Oaxaca en soluciones de software empresarial, procurando el éxito de nuestros clientes en su integración tecnológica empresarial.<br></p>
            </div>
            <div class="col-md-6" style="border: 0 none #cdd1d3 ;">
                <h1 style="text-align: center;color: rgb(255,255,255);font-size: 2.5rem;">Misión</h1>
                <p style="text-align: center;font-size: 1.02rem;color: rgb(255,255,255);">Facilitar la transición al siguiente nivel empresarial de nuestros clientes, ofreciendo software seguro, de calidad y personalizado.</p>
            </div>
        </div>
