...
<head>
    ...
    <title>Proyecto | Muppers.com</title>
    <meta property="og:title" content="Muppers">
    <meta property="og:type" content="article">
    <meta name="description" content="Muppers. Software Development Company | Empresa de Desarrollo de Software. Proyecto realizado por Muppers.">
...
<body><nav class="navbar navbar-dark navbar-expand-md fixed-top bg-dark navbar--apple">
    ...
    <main class="page project-page" style="color: rgb(255,255,255);background: #080808;">
        <section class="portfolio-block project">
            <div class="container">
                <div class="heading">
                    <h2>project name</h2>
                </div>
                <div class="image" style="background-image: url(&quot;assets/img/muppers/muppers-logo.jpg&quot;);"></div>
                <div class="row">
                    ...
                    <div class="col-12 col-md-3 offset-md-1 meta">
                        <div class="tags"><span class="meta-heading" style="color: #56c6c6;">Tags</span><a href="#">Resource</a><a href="#">Project</a><span class="meta-heading" style="color: #56c6c6;">Fecha de despliegue</span><span>25-04-2017</span><span class="meta-heading"
                                style="color: #56c6c6;">Demo</span><a href="#">En este enlace encontrarás una demostración del proyecto, podrás explorarlo con toda libertad</a></div>
                    </div>
                </div>
                <div class="more-projects">
                    ...
                    <div class="row gallery">
                        <div class="col-md-4 col-lg-3">
                            <div class="item"><a href="#"><img class="img-fluid scale-on-hover" src="assets/img/muppers/technology-by-muppers.jpg"></a></div>
                        </div>
                        <div class="col-md-4 col-lg-3">
                            <div class="item"><a href="#"><img class="img-fluid scale-on-hover" src="assets/img/muppers/technology.jpg"></a></div>
                        </div>
                        <div class="col-md-4 col-lg-3">
                            <div class="item"><a href="#"><img class="img-fluid scale-on-hover" src="assets/img/tech/vuejs.png"></a></div>
                        </div>
                        <div class="col-md-4 col-lg-3">
                            <div class="item"><a href="#"><img class="img-fluid scale-on-hover" src="assets/img/tech/github.png"></a></div>
                        </div>
                    </div>
                </div>
            </div>
